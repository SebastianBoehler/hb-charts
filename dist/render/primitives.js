...
export function drawGrid(ctx, width, height, range, mode, palette, ratio) {
...
export function drawCandles(ctx, bars, projection, candles, ratio) {
...
export function drawLine(ctx, layer, x, y, palette) {
    let previous = null;
...
export function drawHistogram(ctx, layer, bars, x, y, baseline, palette, candles) {
...
export function drawRegions(ctx, regions, bars, projection, height) {
    if (bars.length < 2)
        return;
...
export function drawMarkers(ctx, markers, projection, palette) {
...
export function drawLevels(ctx, levels, projection, height, mode, palette) {
