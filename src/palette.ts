...
export const chartPalettes: Record<ChartTheme, ChartPalette> = {
  dark: {
    background: "#101319",
    down: "#ef7d73",
...
export function toneColor(
  tone: "negative" | "neutral" | "positive" | undefined,
  palette: ChartPalette,
) {
  if (tone === "negative") return palette.down;
